...
public class Seller extends NPC {
    ...
    public static final Item[][] stock = {
            {
                    Item.build(ItemIDs.Sickle.ordinal()), Item.build(ItemIDs.Kunai.ordinal()), Item.build(ItemIDs.Sword.ordinal()), Item.build(ItemIDs.Feed.ordinal(), 5),
                    ...
                    Item.build(ItemIDs.DangerousWand.ordinal()),
    ...
    public static final int[][] prices = {
            {11, 12, 16, 7, 2, 12, 1, 5, 3, 2, 7, 20, 30, 10, 8, 15},
            {6, 3, 10,}
    };
