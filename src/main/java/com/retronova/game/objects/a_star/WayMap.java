...
class WayMap {
	...
	public WayMap(Node start, Node end, int range, CheckerNode checker) throws RuntimeException {
		...
		//Grava o nó inicial na posição dele. Antes ia para (X,Y), que é o canto
		//superior esquerdo da grade — a célula do canto passava a conter um nó com
		//coordenadas de outro lugar. Compare com a linha do goal, logo abaixo.
		setNode(start.x, start.y, this.start);
